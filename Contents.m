...
% Version  752  (VBM12)  2015-10-18
% __________________________________________________________________________
% Copyright (C) 2009 Christian Gaser christian.gaser@uni-jena.de
%
% $Id: Contents_info.txt 594 2014-08-29 09:04:22Z gaser $
% ==========================================================================
% Description
% ==========================================================================
% This toolbox is a collection of extensions to the segmentation algorithm 
% of SPM12 (Wellcome Department of Cognitive Neurology) to provide voxel-
...
%   vbm.man                     - notes on VBM12 toolbox
%   CHANGES.txt                  - changes in revisions
%   Contents.m                   - this file
%
% VBM12 functions
%   cg_vbm_bias.m               - configuration file for bias correction between an image pair
%   cg_vbm_bias_run.m           - correct bias between an image pair
%   cg_vbm_debug.m              - print debug information for SPM12 and VBM12
%   cg_vbm_defaults.m           - sets the defaults for VBM12
%   cg_vbm_defs.m               - apply deformations to images
%   cg_vbm_get_defaults.m       - defaults for VBM12
%   cg_vbm_longitudinal.m       - VBM12 for longitudinal data
%   cg_vbm_longitudinal_multi.m - VBM12 for longitudinal data
%   cg_vbm_longitudinal_multi_run.m - VBM12 for longitudinal data
%   cg_vbm_run.m                - runtime funtion for VBM12
%   cg_vbm_tools.m              - wrapper for calling VBM12 utilities
%   cg_vbm_update.m             - check for new updates
%   cg_vbm_write.m              - write out VBM12 results
%   spm_vbm.m                   - toolbox wrapper to call functions
%   tbx_cfg_vbm.m               - configure VBM12
%
% Utility functions
...
%
% Batch functions
%   cg_spm8_batch.m              - batch mode wrapper for spm_jobman for SPM12
%   cg_spm8_batch.sh             - shell script to call matlab batch files from unix
%                                  without gui
%   cg_vbm_batch.m              - batch mode wrapper for spm_jobman for VBM12
%   cg_vbm_batch.sh             - shell script to use vbm from unix without gui
%
% Templates/Images
