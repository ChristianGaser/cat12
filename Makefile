...
MISC_FILES=CAT12-Manual.pdf README.md CHANGES.txt INSTALL.txt standalone templates_MNI152NLin2009cAsym html templates_surfaces templates_surfaces_32k atlases_surfaces atlases_surfaces_32k cat12.* CAT.* distribute_to_server.sh cat_*.sh  cat_long_main*txt glass_brain.mat
