...
MISC_FILES=README.md CHANGES.txt INSTALL.txt doc standalone templates_MNI152NLin2009cAsym templates_surfaces templates_surfaces_32k atlases_surfaces atlases_surfaces_32k cat12.* CAT.* distribute_to_server.sh cat_*.sh  cat_long_main*txt glass_brain.mat mex*
...
scp_precompile:
	...
	-@for i in Mac Linux; do \
	   ...
	   scp -O -P ${PORT} ${ZIPFOLDER}/${NEWVERSION}_r${REVISION}_R2017b_MCR_$${i}.zip  ${STARGET}; \
