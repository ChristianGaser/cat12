%-----------------------------------------------------------------------
% Job saved on 26-Oct-2016 14:08:52 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6685)
...
matlabbatch{3}.spm.tools.cat.estwrite_spm.extopts.darteltpm       = {fullfile(spm('dir'),'toolbox','cat12','templates_1.50mm','Template_1_IXI555_MNI152.nii')};
