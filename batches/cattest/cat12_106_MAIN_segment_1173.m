...
if exp>1 % DEVELOPER
  ...
  matlabbatch{1}.spm.tools.cat.estwrite1173.extopts.registration.cat12atlas          = { fullfile( spm('dir') , 'toolbox' , 'cat12' , 'templates_volumes' , 'cat.nii' ) };
...
if exp
  ...
  matlabbatch{1}.spm.tools.cat.estwrite1173.output.ROImenu.atlases.aal3               = 0;
