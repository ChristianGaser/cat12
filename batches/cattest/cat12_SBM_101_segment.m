...
% -- output ------------------------------------------------------------
if exp, malabbatch{1}.spm.tools.cat.estwrite.output.ROI         = 1; end   % RBM preprocessing
matlabbatch{1}.spm.tools.cat.estwrite.output.surface            = 1;       % SBM preprocessing
% GM
matlabbatch{1}.spm.tools.cat.estwrite.output.GM.native          = 1;
if exp, matlabbatch{1}.spm.tools.cat.estwrite.output.GM.warped  = 1; end
matlabbatch{1}.spm.tools.cat.estwrite.output.GM.mod             = 1;
matlabbatch{1}.spm.tools.cat.estwrite.output.GM.dartel          = 1;
% WM
matlabbatch{1}.spm.tools.cat.estwrite.output.WM.native          = 1;
if exp, matlabbatch{1}.spm.tools.cat.estwrite.output.WM.warped  = 1; end
