...
% oldworld monkeys of cat_tst_cattest.
% ---------------------------------------------------------------------
% Robert Dahnke
...
matlabbatch{1}.spm.tools.cat.estwrite.extopts.darteltpm       = { fullfile( spm('dir') , 'toolbox' , 'cat12' , 'templates_animals' , 'monkey_oldworld_Template_1.nii' ) };
matlabbatch{1}.spm.tools.cat.estwrite.extopts.cat12atlas      = { fullfile( spm('dir') , 'toolbox' , 'cat12' , 'templates_animals' , 'monkey_oldworld_vbm12.nii' ) };
matlabbatch{1}.spm.tools.cat.estwrite.extopts.brainmask       = { fullfile( spm('dir') , 'toolbox' , 'cat12' , 'templates_animals' , 'monkey_oldworld_brainmask.nii' ) };
matlabbatch{1}.spm.tools.cat.estwrite.extopts.T1              = { fullfile( spm('dir') , 'toolbox' , 'cat12' , 'templates_animals' , 'monkey_oldworld_T1.nii' ) };
