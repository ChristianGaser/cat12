...
imagesc(I);
axis off; 
text(80,140,'Computational Anatomy Toolbox','Color',[1 1 1],'Fontsize',FS+4,'Fontweight','bold');
switch species
...
switch expert
  case 1, text(80,90,['Expert Mode'    speciesdisp],'Color',[0.1 0.7 1.0],'Fontsize',FS+2,'Fontweight','bold'); 
  case 2, text(80,90,['Developer Mode' speciesdisp],'Color',[1.0 0.0 0.0],'Fontsize',FS+2,'Fontweight','bold');
end
guidata(hObject, handles);
