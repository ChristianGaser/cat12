...
h041 = uicontrol(...
  ...
  'String',{  'Extract ROI Data...'; 'Extract ROI-based Surface Values'; 'Estimate Volumes inside ROI for External Analysis' },...
  'Style','popupmenu',...
...
if isdeployed
  set(h071,  'String',{  'Internet/Help...     '; 'Manual'; 'VBM Website' },...
