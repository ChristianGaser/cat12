...
if exist(fullfile(spm('dir'),'toolbox','TFCE'))
    set(handles.popupmenu052,'String',{'TFCE-Toolbox','Call TFCE Toolbox'});
else
    set(handles.popupmenu052,'String',{'TFCE-Toolbox','Install TFCE Toolbox'});
end
...
imagesc(I);
axis off; 
text(80,140,'Computational Anatomy Toolbox','Color',[1 1 1],'Fontsize',FS4,'Fontweight','bold');
switch species
...
switch expert
  case 1, text(80,90,['Expert Mode'    speciesdisp],'Color',[0.1 0.7 1.0],'Fontsize',FS3,'Fontweight','bold'); 
  case 2, text(80,90,['Developer Mode' speciesdisp],'Color',[1.0 0.0 0.0],'Fontsize',FS3,'Fontweight','bold');
end
guidata(hObject, handles);
...
...  'DefaultTextFontSize',FS1,...
...  'DefaultUicontrolFontSize',FS1,...
...
h022 = uicontrol(...
  ...
  'String',{  'Check Sample'; 'VBM Data Homogeneity'; 'Surface Data Homogeneity'; 'SPM Design' },...
  'Style','popupmenu',...
...
h031 = uicontrol(...
  ...
  'String',{  'Surface Measures'; 'Extract Additional Surface Parameters '; 'Map Volume (Native Space) to Individual Surface'; 'Nonlinear Co-Register and Map Volume (Native Space) to Individual Surface'; 'Map Normalized Volume (Template Space) to Template Surface' },...
  'Style','popupmenu',...
  'TooltipString','Extract additional surface measures or map volumes to surface',...
  'Value',1,...
...
h041 = uicontrol(...
  ...
  'String',{  'ROI Data'; 'Extract ROI-based Surface Values'; 'Estimate Volumes inside ROI for External Analysis' },...
  'Style','popupmenu',...
  'TooltipString','Extract ROI data using atlases or estimate volumes',...
  'Value',1,...
...
h052 = uicontrol(...
  ...
  'String',{  'TFCE-Toolbox'; 'Estimate'; 'Results' },...
  'Style','popupmenu',...
...
h061 = uicontrol(...
  ...
  'ListboxTop',0,...
  'Position',[x2(1) y1p x2w y1h],...
  'String',{  'Transform SPMs'; 'spmT images'; 'spmF images'; 'spmT surfaces'; 'spmF surfaces' },...
  'Style','popupmenu',...
...
h062 = uicontrol(...
  ...
  'ListboxTop',0,...
  'Position',[x2(2) y1p x2w y1h],...
  'String',{  'View Results'; 'Slice Overlay'; 'Display Surface Results' },...
  'Style','popupmenu',...
...
if isdeployed
  set(h071,  'String',{  'Help...     '; 'Manual'; 'VBM Website' },...
  ...
  set(h071,  'String',{  'Help...     '; 'Interactive Help'; 'Manual'; 'Update'; 'VBM Website' },...
...
h080 = uicontrol(...
  ...
  'ListboxTop',0,...
  'Position',[0 0.005 1 0.0216836734693878],...
