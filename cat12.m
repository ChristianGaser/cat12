...
'String',{  'Check Sample Homogeneity...'; 'VBM Data'; 'Surface Data'; 'Data Defined in Existing SPM Design' },...
'Style','popupmenu',...
'TooltipString','Check sample homogeneity using correlation across sample',...
'Value',1,...
'UserData',{  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.check_cov'');' 'spm_jobman(''interactive'','''',''spm.tools.cat.stools.check_mesh_cov'');' 'cat_stat_check_cov_SPM;'},...
'Tag','popupmenu022',...
'CreateFcn', {@local_CreateFcn, blanks(0), appdata} );
