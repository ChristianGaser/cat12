...
web(fullfile(fileparts(which('cat12')),'doc','index.html#quick'));
...
h02 = uicontrol(...
  ...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'doc','images','cat_hd02blue2.png')),tg),...
...
str_vol = {center('Volume Tools'),...
  ...
  'Multi-subject Image Calculator',...
  'Longitudinal Registration',...
  'Rescan Average', ...
  'Calculate Volume Average'};
userdata_vol = {...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.sanlm'');'...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.mp2rage'');'...
  ...
  'cat_stat_diff;'...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.mimcalcto'');'...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.series'');'...
  'spm_jobman(''interactive'','''',''spm.tools.cat.tools.savg'');'...
...
h07 = uicontrol(...
  ...
  'String',{  center('Surface Tools');...
    'Run SPM-based Surface Reconstruction ';...
  ...
  'UserData',{...
    'spm_jobman(''interactive'','''',''spm.tools.cat.estwrite_spm'')'...
...
h12 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'doc','images','cat_hd02red.png')),tg),...
...
h13 = uicontrol(...
  ...
  'String',{  center('Data Quality');...
    ...
    'Check Sample Homogeneity for long. Data';...
...    'Check Sample Homogeneity for Very Large Samples Using Mean z-Score';...
...    'Run Segmentation-Based Image Quality Estimation';...
    'Get Weighted Overall Image Quality';...
    'Check SPM Design';...
    'Single Slice Display' },...
  'UserData',{...
    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.check_homogeneity'');'...
    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.check_cov'');'...
...    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.quality_measures'');'...
...    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.iqe'');'...
    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.iqr'');'...
    'spm_jobman(''interactive'','''',''spm.tools.cat.tools.check_SPM'');'...
...
h21 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'doc','images','cat_hd02green.png')),tg),...
...
h23 = uicontrol(...
  ...
  'String',{  center('View Results');...
    ...
    'Surface Overlay (for Surfaces and GM-Volumes)' },...
  'UserData',{...
...
h31 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'doc','images','cat_hd02purple.png')),tg),...
...
h32 = uicontrol(...
  ...
  'String',{  center('Help');...
    ...
    'Website' },...
  'UserData',{...
    'web(fullfile(fileparts(which(''cat12'')),''doc'',''index.html''));' ...
    'web(''https://neuro-jena.github.io'');' },...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'));
...
h35 = uicontrol(...
  ...
  'TooltipString','Switch Between Standard and Expert Mode',...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
  'Tag','pushMode',...
  'UserData',[],...
  'FontSize',FS,...
...
if expert == 1
  set(h35,'String','Switch to Standard Mode');
