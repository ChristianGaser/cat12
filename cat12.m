...
imagesc(cat_bg); 
axis('off'); 
text(sz(1)/20,sc*70,'Computational Anatomy Toolbox','Color',[1 1 1],'Fontsize',FS+4,'Fontweight','bold');
...
switch expert
  case 1, text(sz(1)/20,sc*90,['Expert Mode'    speciesdisp],'Color',[0.1 0.7 1.0],'Fontsize',FS+2,'Fontweight','bold'); 
  case 2, text(sz(1)/20,sc*90,['Developer Mode' speciesdisp],'Color',[1.0 0.0 0.0],'Fontsize',FS+2,'Fontweight','bold');
end
guidata(hObject, handles);
...
h02 = uicontrol(...
  ...
  'cdata',imread(fullfile(spm('dir'),'toolbox','cat12','html','images','cat_hd02blue2.png')),...
...
h05 = uicontrol(...
  ...
  'String',{  center('ROI Tools');...
    ...
    'Estimate Volumes Inside ROI for External Analysis' },...
  'UserData',{...
...
h12 = uicontrol(...
  ...
  'BackgroundColor',[0.94 0.94 0.94],...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',imread(fullfile(spm('dir'),'toolbox','cat12','html','images','cat_hd02red.png')),...
...
h21 = uicontrol(...
  'Parent',h0,...
  'Units','pixels',...
  'String','Data Presentation',...
  'Style','pushbutton',...
  'enable','inactive',...
  'BackgroundColor',[0.94 0.94 0.94],...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',imread(fullfile(spm('dir'),'toolbox','cat12','html','images','cat_hd02green.png')),...
...
h31 = uicontrol(...
  ...
  'BackgroundColor',[0.94 0.94 0.94],...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',imread(fullfile(spm('dir'),'toolbox','cat12','html','images','cat_hd02purple.png')),...
...
h32 = uicontrol(...
  ...
  'UserData',{...
    ...
    'try,web(''http://www.neuro.uni-jena.de/vbm'',''-browser'');end' },...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'));
	...
	if isdeployed
		...
		set(h33,...
			'String',{  center('Updates/Add-Ons');...
				...
				'Install CAT Atlases to SPM'  },...
			'UserData',{...
				'spm(''alert'',evalc(''cat_update(1)''),''CAT Update'');'...
				'cat_install_atlases' })
	end
...
appdata = [];
appdata.lastValidTag = 'pushExit_Callback';
...
h35 = uicontrol(...
  ...
  'Callback',@(hObject,eventdata)cat12('pushExit_Callback',hObject,eventdata,guidata(hObject)),...
  'TooltipString','Exit Through the Gift Shop',...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
  'Tag','pushExit',...
  'UserData',[],...
  'FontSize',FS,...
...
I       = cat_bg; 
[X2,Y2] = meshgrid(1:size(I,2)/h0pos(3):size(I,2),1:size(I,1)/h0pos(4):size(I,1)); clear I2;
