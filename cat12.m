...
h02 = uicontrol(...
  ...
  'BackgroundColor',[0.2627 0.6039 0.8627],...
  'Callback',blanks(0),...
  'TooltipString',blanks(0),...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
  'Tag','textPreprocessing',...
...
...  'BackgroundColor',[0.6196 0.8118 0.8392],...
  'BackgroundColor',[0.49 0.70 0.84],...
  'Callback',blanks(0),...
  'TooltipString',blanks(0),...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
...  'BackgroundColor',[0.9686 0.9098 0.7843],...
  'BackgroundColor',[0.72 0.80 0.81],...
  'Callback',blanks(0),...
  'TooltipString',blanks(0),...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
...
...  'BackgroundColor',[0.9020 0.7020 0.6588],...
  'BackgroundColor',[0.83 0.85 0.80],...
  'Callback',blanks(0),...
  'TooltipString',blanks(0),...
  'CreateFcn', {@local_CreateFcn, blanks(0), appdata} ,...
  'Tag','textTools',...
...
if ismac & cat_io_matlabversion<=20102
  out = in;
else
