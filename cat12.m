...
if nargin <= 1
  ...
  cat_bg = imread(fullfile(fileparts(mfilename('fullpath')),'html','images','cat_bg.jpg'));
...
h02 = uicontrol(...
  ...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'html','images','cat_hd02blue2.png')),tg),...
...
h12 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'html','images','cat_hd02red.png')),tg),...
...
h21 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'html','images','cat_hd02green.png')),tg),...
...
h31 = uicontrol(...
  ...
  'enable','inactive',...
  'ForegroundColor',[0.9 0.9 0.9],...
  'cdata',cat_interp_menuimgs(imread(fullfile(fileparts(mfilename('fullpath')),'html','images','cat_hd02purple.png')),tg),...
...
h32 = uicontrol(...
  ...
  'String',{  center('Help');...
    ...
    'Interactive Help' },...
  'UserData',{...
    'web(fullfile(fileparts(mfilename(''fullpath'')),''CAT12-Manual.pdf''),''-browser'');'...
    'web(fullfile(fileparts(mfilename(''fullpath'')),''html'',''cat.html''));' },...
  'FontSize',FS,...
  'FontName',get(0,'defaultuicontrolFontName'));
