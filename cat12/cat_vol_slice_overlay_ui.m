...
%OV.reference_image = fullfile(cat_get_defaults('extopts.pth_templates'),'Template_T1.nii');
% or its masked version
OV.reference_image = fullfile(cat_get_defaults('extopts.pth_templates'),'Template_T1_masked.nii');
