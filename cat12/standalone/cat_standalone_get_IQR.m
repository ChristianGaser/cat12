% Batch file for getting weighted overall image quality for SPM12/CAT12 standalone installation
%
%_______________________________________________________________________
% $Id$

% data field, that will be dynamically replaced by cat_standalone.sh
matlabbatch{1}.spm.tools.cat.tools.iqr.data_xml = '<UNDEFINED>';

% Entry for txt output filename
...
%matlabbatch{1}.spm.tools.cat.tools.iqr.iqr_name = '<UNDEFINED>';
