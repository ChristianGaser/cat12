...
bids_folder_cross="derivatives/CAT26.0.rc4"     # define BIDS path for cross-sectional data (relative to dataset root)
bids_folder_long="derivatives/CAT26.0.rc4_long" # define BIDS path for longitudinal data (relative to dataset root)
fg=" --fg " # keep process in foreground which might be neccessary for batch/queue systems
log_folder="${dirname}/derivatives/logs_CAT26.0.rc4/${subjid}" # the directory for the log files. 
