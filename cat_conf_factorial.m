...
scans.tag     = 'scans';
scans.name    = 'Scans';
scans.help    = {'Select the (smoothed) data.  They must all have the same data dimensions, orientation and size etc.'};
...
scans1.help    = {'Select the (smoothed) data from sample 1.  They must all have the same data dimensions, orientation, and size etc.'};
...
scans2.help    = {'Select the (smoothed) data from sample 2.  They must all have the same data dimensions, orientation, and size etc.'};
...
scans.help    = {'Select the pair of (smoothed) data.'};
scans.filter  = {'image','resampled.*\.(gii)$'};
scans.ufilter = '.*';
scans.num     = [2 2];
...
scans.tag     = 'scans';
scans.name    = 'Scans';
scans.help    = {'Select the (smoothed) data for this cell.  They must all have the same data dimensions, orientation, and size etc.'};
scans.filter  = {'image','resampled.*\.(gii)$'};
scans.ufilter = '.*';
scans.num     = [1 Inf];
...
scans.tag     = 'scans';
scans.name    = 'Scans';
scans.help    = {'Select the (smoothed) data to be analysed.  They must all have the same data dimensions, orientation, and size etc.'};
scans.filter  = {'image','resampled.*\.(gii)$'};
scans.ufilter = '.*';
scans.num     = [1 Inf];
