...
nproc.help    = {
    ...
    ''
    'Please note that no additional modules in the batch can be run except CAT segmentation. Any dependencies will be broken for subsequent modules.'
  };
...
vol2tempsurf.help = {
  ...
  'The template surface was generated by CAT surface processing of the average of 555 Dartel-normalized images of the IXI database that were also used to create the IXI Dartel template.   '
  ''
