...
cat.extopts.print        = 2;     % display and print out pdf-file of results: 0 - off, 2 - volume only (use this to avoid problems on server that do not support openGL), 2 - volume and surface (default)
