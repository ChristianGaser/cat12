...
% data trimming of midpoint average image and applying trimming and mask to realigned images
matlabbatch{3}.spm.tools.cat.tools.datatrimming.image_selector.subjectimages{1}(1) = cfg_dep('Longitudinal Rigid Registration: Midpoint Average', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','avg', '()',{':'}));
...
% cat12 segmentation of trimmed realigned images
...
if delete_temp
  ...
  matlabbatch{6}.cfg_basicio.file_dir.file_ops.file_move.files(3) = cfg_dep('Image data trimming: first images of all subjects', substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','image_selector', '.','firstimages'));
end
