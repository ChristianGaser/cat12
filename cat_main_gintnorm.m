...
% $Id$
  ...
  if T3th3(1)>T3th3(3) && T3th3(2)>T3th3(3) && T3th3(1)>T3th3(2) % invers (T2 / PD)
    ...
    T3th  = [min(Ysrc(~isnan(Ysrc(:)) & ~isinf(Ysrc(:)))) ...
             min( T3th3(3)*0.2+0.8*min(Ysrc(~isnan(Ysrc(:)) & ~isinf(Ysrc(:)))) , ...
                  min(res.mn(res.lkp==6 & res.mg'>0.3)) ) ...
             T3th3 ...
             ([T3th3(3)*0.3+0.7*min(Ysrc(~isnan(Ysrc(:)) & ~isinf(Ysrc(:)))) ...
              mean([T3th3(3),min(res.mn(res.lkp==6 & res.mg'>0.1))]) ...
  ...
  elseif T3th3(1)<T3th3(2) && T3th3(2)<T3th3(3) % T1
    ...
    T3th3 = [max( min(res.mn(res.lkp==3 & res.mg'>0.3))*.05 + .95*max(res.mn(res.lkp==2 & res.mg'>0.3)) , ...
                  min(res.mn(res.lkp==3 & res.mg'>0.3))) ...
  ...
  %  -------------------------------------------------------------------
    ...
    BGmin = min(Ysrc(~isnan(Ysrc(:)) & ~isinf(Ysrc(:)))); 
    BGcon = max([BGmin*1.1,T3th3(1) - mean(diff(T3th3)),median(Ysrc(Ycls{6}(:)>128))]);
    BMth  = min(BGcon,T3th_spm(1) - diff(T3th_spm(1:2))); %max(0.01,cat_stat_nanmedian(Ysrc(Ybm(:))));
