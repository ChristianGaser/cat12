function varargout = cat_get_defaults1585(defstr, varargin)
% Get/set the defaults values associated with an identifier
% FORMAT defval = cat_get_defaults1585(defstr)
...
%
% FORMAT cat_get_defaults1585(defstr, defval)
...
%
% FORMAT cat_get_defaults1585(defstr, 'rmfield')
% Removes last field of defstr eg. defstr = 'opts.sopt.myfield' will remove 
% 'myfield'. 
%
% FORMAT cat_get_defaults1585(defstr, 'rmentry')
% Removes last field of defstr eg. defstr = 'opts.sopt.myfield' will remove 
