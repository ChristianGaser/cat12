function [Ysrc,Ycls,Yb,Yb0,job,res,T3th,stime2] = cat_main_updateSPM1585(Ysrc,P,Yy,tpm,job,res,stime,stime2)
...
% $Id$
  ...
  elseif job.extopts.gcutstr==2
    [Yb,Ybb,Yg,Ydiv] = cat_main_APRG1585(Ysrc,P,res,T3th);
  else
