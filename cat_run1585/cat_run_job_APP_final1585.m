function  [Ym,Yp0,Yb] = cat_run_job_APP_final1585(Ysrco,Ym,Yb,Ybg,vx_vol,gcutstr,verb)
...
% nicht WM: Ydiv.*Yg<-0.02
  ...
  Ywi   = cat_vol_approx1585(Ywi,'nn',resT2.vx_volr,2);
  ...
  if zeroBG
    ...
    %Ybc2 = cat_vol_approx1585(Ybc,'nn',resT2.vx_volr,4); % no aproximation to correct only in the backgound!  
