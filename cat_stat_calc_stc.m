...
% $Id$
  ...
  if strcmp(stctype(1:4),'temp')
    % Use cat_io_BIDS to get proper directory structure instead of relative paths
    BIDS = cat_io_BIDS(VT0.fname, cat_get_defaults);
    cat_io_writenii(VT0,Ystc,BIDS(1).mridir,'te', ...
