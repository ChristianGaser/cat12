...
% -------------------------------------------------------------------------
  ...
  cscc.H.help = uicontrol(cscc.H.figure,...
    ...
    'callback',['global cscc; spm_help(''!Disp'',''/Users/dahnke/Documents/MATLAB/' ...
      'spm12/toolbox/cat12/html/cat_tools_checkcov.html'','''',cscc.H.graphics);']);
...
cscc.pos.trashpopup(2) = cscc.H.figure.Position(2) + (cscc.H.figure.Position(4) - cscc.pos.trashpopup(4)) - 24;        
    ...
    cscc.H.ETB.help = uicontrol(cscc.H.ETB.main,...
      ...
      ['global cscc; ' ...
       ...
       'end; ' ...
       'spm_help(''!Disp'',''/Users/dahnke/Documents/MATLAB/' ...
          'spm12/toolbox/cat12/html/cat_tools_checkcov_exclusion.html'','''',cscc.H.helpfig);']);
...
%-----------------------------------------------------------------------
  ...
  uicontrol('Parent',d,'TooltipString','More information to this operation',...
     ...
     'Callback',['delete(gcf); spm_help(''!Disp'',''/Users/dahnke/Documents/MATLAB/' ...
      'spm12/toolbox/cat12/html/cat_tools_checkcov.html'','''',spm_figure(''GetWin'',''Graphics'')); ']); %    
return
...
%-----------------------------------------------------------------------
  ...
  title(cscc.H.scat(cscc.H.scata),...
    '<--- Best -- Mahalanobis distance (Color) -- Worst ---->  ','FontSize',...
...
%-----------------------------------------------------------------------
  ...
  if (length(data_boxp) > 2)
    ...
    elseif quality_order < 0 
      text(xcscc.pos, ylim_max,'Low rating (poor quality) ------>  ','Color','red','Rotation',...
          90,'HorizontalAlignment','right','FontSize',cscc.display.FS(9),'FontWeight','Bold')
      text(xcscc.pos, ylim_min,'<----- cscc.High rating (good quality)  ','Color',[0 0.8 0],'Rotation',...
          90,'HorizontalAlignment','left','FontSize',cscc.display.FS(9),'FontWeight','Bold')
    end
