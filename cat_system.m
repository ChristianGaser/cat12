...
% the system one (e.g. missing GLIBCXX_3.4.29 and higher).  Unsetting
...
% untouched.
% Note: the same trick is intentionally NOT applied on macOS because the CAT
% binaries there bundle their own dylibs and rely on DYLD_LIBRARY_PATH to
% locate them — unsetting it would prevent those binaries from loading.
if isunix && ~ismac
