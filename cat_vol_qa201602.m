function varargout = cat_vol_qa201602(action,varargin)
      ...
      for fi=1:numel(Pp0)
        try
          if exist(Po{fi},'file')
            ...
            error('cat_vol_qa201602:noYo','No original image.');
          end
          ...
          if ~isempty(Pm{fi}) && exist(Pm{fi},'file')
            ...
            error('cat_vol_qa201602:noYm','No corrected image.');
          end
  
          [QASfi,QAMfi,cat_qa_warnings{fi}] = cat_vol_qa201602('cat12',Yp0,Vo,Ym,'',cat_warnings,species,opt);
          ...
          try %#ok<TRYNC>
            ...
            switch e.identifier
              case {'cat_vol_qa201602:noYo','cat_vol_qa201602:noYm','cat_vol_qa201602:badSegmentation'}
                em = e.identifier;
              otherwise
