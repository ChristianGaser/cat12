function realign = cat_cfg_realign
% Configuration file
...
weight.values  = {0 1};
weight.def     = @(val)cat_get_defaults('realign.weight', val{:});
% ---------------------------------------------------------------------
% halfway Halfway
% ---------------------------------------------------------------------
halfway         = cfg_menu;
...
halfway.values  = {0 1};
halfway.def     = @(val)cat_get_defaults('realign.halfway', val{:});
% ---------------------------------------------------------------------
...
ignore_mat.def     = @(val)cat_get_defaults('extopts.ignore_mat', val{:});
% ---------------------------------------------------------------------
...
estimate.name    = 'CAT12 Realign: Estimate';
...
write         = cfg_exbranch;
write.tag     = 'write';
write.name    = 'CAT12 Realign: Reslice';
...
estwrite.name    = 'CAT12 Realign: Estimate & Reslice';
...
realign         = cfg_choice;
realign.tag     = 'realign';
realign.name    = 'Realign longitudinal data';
realign.help    = {'Within-subject registration of longitudinal data.'};
