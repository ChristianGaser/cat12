...
%tpm.dir = fullfile(spm('Dir'),'toolbox','Seg');
%tpm.val = {fullfile(spm('dir'),'toolbox','Seg','TPM.nii')};
tpm.help = {...
[...
'Select the tissue probability image. '...
...
vox      = entry('Voxel size','vox','e',[1 3]);
vox.val  = {[1 1 1]};
vox.help = {...
...
extopts      = branch('Extended options','extopts',{vox,bb,brainmask, print});
