...
defaults.vbm8.output.grey.native = 0;
defaults.vbm8.output.grey.warped = 1;
defaults.vbm8.output.grey.mod    = 1;
defaults.vbm8.output.grey.dartel = 0;

defaults.vbm8.output.white.native = 0;
defaults.vbm8.output.white.warped = 1;
defaults.vbm8.output.white.mod    = 1;
defaults.vbm8.output.white.dartel = 0;

defaults.vbm8.output.csf.native = 0;
defaults.vbm8.output.csf.warped = 0;
defaults.vbm8.output.csf.mod    = 0;
defaults.vbm8.output.csf.dartel = 0;
...
defaults.vbm8.extopts.brainmask_th = 0.5;	% Brainmask threshold
defaults.vbm8.extopts.brainmask    = cellstr(fullfile(fileparts(which(mfilename)),'TPM.nii'));;	% Brainmask
