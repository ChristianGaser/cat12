...
matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(2).tgt_spec{1}(1).name = 'filter';
matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(2).tgt_spec{1}(1).value = 'image';
matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(2).tgt_spec{1}(2).name = 'strtype';
matlabbatch{2}.spm.spatial.realign.estwrite.data{1}(2).tgt_spec{1}(2).value = 'e';
...
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1) = cfg_dep;
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1).tname = 'Longitudinal images for one subject';
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1).tgt_spec = {};
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1).sname = 'Realign: Estimate & Reslice: Resliced Images (Sess 1)';
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1).src_exbranch = substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{3}.spm.tools.vbm8.bias.subj.mov(1).src_output = substruct('.','sess', '()',{1}, '.','rfiles');
matlabbatch{3}.spm.tools.vbm8.bias.bias_opts.nits = 8;
matlabbatch{3}.spm.tools.vbm8.bias.bias_opts.fwhm = 60;
matlabbatch{3}.spm.tools.vbm8.bias.bias_opts.reg = 1e-06;
matlabbatch{3}.spm.tools.vbm8.bias.bias_opts.lmreg = 1e-06;
...
matlabbatch{4}.spm.tools.vbm8.estwrite.extopts.open_th = 0.25;
matlabbatch{4}.spm.tools.vbm8.estwrite.extopts.dilate = 1;
...
matlabbatch{5}.spm.tools.vbm8.estwrite.data(1).src_exbranch = substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{5}.spm.tools.vbm8.estwrite.extopts.open_th = 0.25;
matlabbatch{5}.spm.tools.vbm8.estwrite.extopts.dilate = 1;
...
matlabbatch{7}.spm.util.defs.comp{1}.def(1) = cfg_dep;
matlabbatch{7}.spm.util.defs.comp{1}.def(1).tname = 'Deformation Field';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).tgt_spec{1}(1).name = 'filter';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).tgt_spec{1}(1).value = 'image';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).tgt_spec{1}(2).name = 'strtype';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).tgt_spec{1}(2).value = 'e';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).sname = 'VBM8: Estimate & Write: Deformation Field';
matlabbatch{7}.spm.util.defs.comp{1}.def(1).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.spm.util.defs.comp{1}.def(1).src_output = substruct('()',{1}, '.','fordef', '()',{':'});
matlabbatch{7}.spm.util.defs.ofname = '';
matlabbatch{7}.spm.util.defs.fnames(1) = cfg_dep;
matlabbatch{7}.spm.util.defs.fnames(1).tname = 'Apply to';
matlabbatch{7}.spm.util.defs.fnames(1).tgt_spec = {};
matlabbatch{7}.spm.util.defs.fnames(1).sname = 'VBM8: Estimate & Write: p1 Images';
matlabbatch{7}.spm.util.defs.fnames(1).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.spm.util.defs.fnames(1).src_output = substruct('.','tiss', '()',{1}, '.','c', '()',{':'});
matlabbatch{7}.spm.util.defs.fnames(2) = cfg_dep;
matlabbatch{7}.spm.util.defs.fnames(2).tname = 'Apply to';
matlabbatch{7}.spm.util.defs.fnames(2).tgt_spec = {};
matlabbatch{7}.spm.util.defs.fnames(2).sname = 'VBM8: Estimate & Write: p2 Images';
matlabbatch{7}.spm.util.defs.fnames(2).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.spm.util.defs.fnames(2).src_output = substruct('.','tiss', '()',{2}, '.','c', '()',{':'});
matlabbatch{7}.spm.util.defs.fnames(3) = cfg_dep;
matlabbatch{7}.spm.util.defs.fnames(3).tname = 'Apply to';
matlabbatch{7}.spm.util.defs.fnames(3).tgt_spec = {};
matlabbatch{7}.spm.util.defs.fnames(3).sname = 'VBM8: Estimate & Write: p1 Images';
matlabbatch{7}.spm.util.defs.fnames(3).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.spm.util.defs.fnames(3).src_output = substruct('.','tiss', '()',{1}, '.','c', '()',{':'});
matlabbatch{7}.spm.util.defs.fnames(4) = cfg_dep;
matlabbatch{7}.spm.util.defs.fnames(4).tname = 'Apply to';
matlabbatch{7}.spm.util.defs.fnames(4).tgt_spec = {};
matlabbatch{7}.spm.util.defs.fnames(4).sname = 'VBM8: Estimate & Write: p2 Images';
matlabbatch{7}.spm.util.defs.fnames(4).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{7}.spm.util.defs.fnames(4).src_output = substruct('.','tiss', '()',{2}, '.','c', '()',{':'});
matlabbatch{7}.spm.util.defs.interp = 1;
