...
matlabbatch{8}.cfg_basicio.file_move.files(1).sname = 'Realign: Estimate & Reslice: Resliced Images (Sess 1)';
matlabbatch{8}.cfg_basicio.file_move.files(1).src_exbranch = substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(1).src_output = substruct('.','sess', '()',{1}, '.','rfiles');
...
matlabbatch{8}.cfg_basicio.file_move.files(2).sname = 'Intra-subject bias correction: Bias corrected images (Subj 1)';
matlabbatch{8}.cfg_basicio.file_move.files(2).src_exbranch = substruct('.','val', '{}',{3}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(2).src_output = substruct('()',{1}, '.','files');
...
matlabbatch{8}.cfg_basicio.file_move.files(3).sname = 'VBM8: Estimate & Write: Seg Params';
matlabbatch{8}.cfg_basicio.file_move.files(3).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(3).src_output = substruct('.','param', '()',{':'});
...
matlabbatch{8}.cfg_basicio.file_move.files(4).sname = 'VBM8: Estimate & Write: Deformation Field';
matlabbatch{8}.cfg_basicio.file_move.files(4).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(4).src_output = substruct('()',{1}, '.','fordef', '()',{':'});
...
matlabbatch{8}.cfg_basicio.file_move.files(5).sname = 'VBM8: Estimate & Write: p1 Images';
matlabbatch{8}.cfg_basicio.file_move.files(5).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(5).src_output = substruct('.','tiss', '()',{1}, '.','c', '()',{':'});
...
matlabbatch{8}.cfg_basicio.file_move.files(6).sname = 'VBM8: Estimate & Write: p2 Images';
matlabbatch{8}.cfg_basicio.file_move.files(6).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(6).src_output = substruct('.','tiss', '()',{2}, '.','c', '()',{':'});
...
matlabbatch{8}.cfg_basicio.file_move.files(7).tgt_spec{1}(1).value = 'mat';
...
matlabbatch{8}.cfg_basicio.file_move.files(7).sname = 'VBM8: Estimate & Write: Seg Params';
matlabbatch{8}.cfg_basicio.file_move.files(7).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(7).src_output = substruct('.','param', '()',{':'});
...
matlabbatch{8}.cfg_basicio.file_move.files(8).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{8}.cfg_basicio.file_move.files(10).sname = 'Realign: Estimate: Realignment Param File (Sess 1)';
matlabbatch{8}.cfg_basicio.file_move.files(10).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(10).src_output = substruct('.','sess', '()',{1}, '.','rpfile');
...
matlabbatch{8}.cfg_basicio.file_move.files(11).sname = 'Realign: Estimate: Realigned Images (Sess 1)';
matlabbatch{8}.cfg_basicio.file_move.files(11).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.cfg_basicio.file_move.files(11).src_output = substruct('.','sess', '()',{1}, '.','cfiles');
