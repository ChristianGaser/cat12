...
nits.strtype = 'n';
nits.num  = [1 1];
nits.def     = @(val)cat_get_defaults('bias.nits_bias', val{:});
...
biasfwhm.def     = @(val)cat_get_defaults('bias.biasfwhm', val{:});
biasfwhm.help = {[...
...
biasreg.def     = @(val)cat_get_defaults('bias.biasreg', val{:});
biasreg.help = {[...
...
lmreg.def     = @(val)cat_get_defaults('bias.lmreg', val{:});
lmreg.help = {[...
