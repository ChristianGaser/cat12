...
nits.strtype = 'n';
nits.num  = [1 1];
nits.def     = @(val)cg_vbm_get_defaults('bias.nits_bias', val{:});
...
biasfwhm.def     = @(val)cg_vbm_get_defaults('bias.biasfwhm', val{:});
biasfwhm.help = {[...
...
biasreg.def     = @(val)cg_vbm_get_defaults('bias.biasreg', val{:});
biasreg.help = {[...
...
lmreg.def     = @(val)cg_vbm_get_defaults('bias.lmreg', val{:});
lmreg.help = {[...
