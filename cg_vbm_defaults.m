...
vbm.extopts.vx_res      = 0.9;  % resolution threshold for partioning, skull-stripping, ...
...
vbm.extopts.gcutCSF     = 0;    % gcut+: brain mask with surrounding CSF (WARNING: CSF-contrast depend strongly on the MR-protocol)
...
vbm.extopts.LAS         = 1;    % Local Adaptive Segmentation (VMB12i): 0 - no adaption; 1 - adaption; 2 - adaption + sharpening
vbm.extopts.LASstr      = 0.5;  % Strength of the Filtering of the local adaption (also B3C!): 0 - lower adaption; 1 - strong adaption
vbm.extopts.BVC         = 1;    % Blood Vessel Correction (in development)
vbm.extopts.WMHC        = 1;    % correction for WM hyperintensities (in development): 0 - no; 1 - only for Dartel; 2 - also for SEG
vbm.extopts.WMHCstr     = 0.5;  % strength of WM hyperintensity correction (in development): 0 for lower, 1 for stronger corrections
