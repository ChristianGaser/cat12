...
'(e.g. normalized images). The idea of this tool is to check the correlation of all files across the sample.'],...
'',[...
'The correlation is calculated between all images and the mean for each image is plotted using a boxplot and the indicated ',...
'filenames. The smaller the mean correlation the more deviant is this image from the sample mean. ',...
...
'correlation is plotted at the y-axis and the x-axis reflects the image order. Images are plotted from left to right which is helpful if ',...
...
'',[...
'The correlation is calculated between all images and the mean for each image is plotted using a boxplot and the indicated ',...
'filenames. The smaller the mean correlation the more deviant is this surface from the sample mean. ',...
'In the plot outliers from ',...
'the sample are usually isolated from the majority of images which are clustered around the sample mean. The mean ',...
'correlation is plotted at the y-axis and the x-axis reflects the image order. Images are plotted from left to right which is helpful if ',...
