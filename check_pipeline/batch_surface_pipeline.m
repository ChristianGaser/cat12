...
%__________________________________________________________________________
matlabbatch{8}.spm.tools.cat.tools.calcvol.data_xml = {
                                                       fullfile(pth,'report/cat_IXI002-Guys-0828-T1.xml')
                                                       fullfile(pth,'report/cat_IXI016-Guys-0697-T1.xml')
                                                       fullfile(pth,'report/cat_IXI017-Guys-0698-T1.xml')
                                                       fullfile(pth,'report/cat_IXI019-Guys-0702-T1.xml')
                                                       };
matlabbatch{8}.spm.tools.cat.tools.calcvol.calcvol_TIV = 1;
matlabbatch{8}.spm.tools.cat.tools.calcvol.calcvol_name = 'TIV.txt';
%__________________________________________________________________________
matlabbatch{9}.spm.tools.cat.stools.vol2surf.data_vol     = {fullfile(pth,'IXI002-Guys-0828-T1.nii,1')};
matlabbatch{9}.spm.tools.cat.stools.vol2surf.data_mesh_lh = {fullfile(pth,'surf/lh.central.IXI002-Guys-0828-T1.gii')};
matlabbatch{9}.spm.tools.cat.stools.vol2surf.sample = {'maxabs'};
matlabbatch{9}.spm.tools.cat.stools.vol2surf.datafieldname = 'intensity';
matlabbatch{9}.spm.tools.cat.stools.vol2surf.mapping.rel_equivol_mapping.class = 'GM';
matlabbatch{9}.spm.tools.cat.stools.vol2surf.mapping.rel_equivol_mapping.startpoint = -0.5;
matlabbatch{9}.spm.tools.cat.stools.vol2surf.mapping.rel_equivol_mapping.steps = 7;
matlabbatch{9}.spm.tools.cat.stools.vol2surf.mapping.rel_equivol_mapping.endpoint = 0.5;
%__________________________________________________________________________
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(1) = cfg_dep('Extract additional surface parameters: Left gyrification', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','lPGI', '()',{':'}));
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(2) = cfg_dep('Extract additional surface parameters: Right gyrification', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','rPGI', '()',{':'}));
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(3) = cfg_dep('Resample and Smooth Surface Data: Merged Resample & Smooth', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','Psdata', '()',{':'}));
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(4) = cfg_dep('Extract ROI-based surface values: Extracted Surface ROIs', substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','xmlname', '()',{':'}));
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(5) = cfg_dep('Threshold and transform spmT surfaces: Transform & Threshold spm surfaces', substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Pname'));
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(6) = cfg_dep('Threshold and transform spmF surfaces: Transform & Threshold spm surfaces', substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','Pname'));
