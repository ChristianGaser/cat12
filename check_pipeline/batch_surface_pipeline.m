...
%__________________________________________________________________________
matlabbatch{2}.spm.tools.cat.stools.surfresamp.data_surf(1) = cfg_dep('Extract additional surface parameters: Left gyrification', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('()',{1}, '.','lPGI', '()',{':'}));
...
%__________________________________________________________________________
matlabbatch{3}.spm.tools.cat.stools.check_mesh_cov.data_surf{1}(1) = cfg_dep('Resample and Smooth Surface Data: Merged resampled gyrification', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sample', '()',{1}, '.','Psdata'));
...
matlabbatch{10}.cfg_basicio.file_dir.file_ops.file_move.files(2) = cfg_dep('Resample and Smooth Surface Data: Merged resampled gyrification', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sample', '()',{1}, '.','Psdata'));
