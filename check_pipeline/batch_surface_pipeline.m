...
%__________________________________________________________________________
matlabbatch{3}.spm.tools.cat.stools.check_mesh_cov.data_surf{1}(1) = cfg_dep('Resample and Smooth Surface Data: Merged resampled MNIgyrification', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','sample', '()',{1}, '.','Psdata'));
