...
%  ---------------------------------------------------------------------
  ...
  Ygm = Ygm | (Ygmt>eps & Ycsfd<mean(Ygmt(Ygmt>0)) & Ycd<mean(Ygmt(Ygmt>0))*(1.5-Ym) & Yl1 & ~Yvt & Yl1<3);
  Ygm = Ygm & Ypp>0.5/max(1,Ygmt) & ~(Ypp-Ygmt/10>0.5);
  Ygms = smooth3(Ygm); Ygm(Ygms<0.25)=0; Ygm(Ygms>0.75)=1; clear Ygms;
