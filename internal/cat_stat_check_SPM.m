...
%
% Calls cat_stat_check_cov2 and splits data into different samples
...
if check_zscore
  ...
  % use SPM design matrix
  job_check_zscore.SPM = SPM;

  cat_stat_check_cov2(job_check_zscore);
end
