...
% Copyright 2014 The MathWorks, Inc.
  ...
  methods
    ...
    function updateColor(this)
      set(this.NodeMarker,'Color',this.Color);
      set(this.Connection,'Color',this.Color);
    end
    ...
    function updateTextLabel(this)
      ...
      set(this.TextLabel,'Position', 1.05*this.Position);
      if abs(t) > pi/2
        set(this.TextLabel,'Rotation',180*(t/pi + 1));
        set(this.TextLabel,'HorizontalAlignment', 'right');
      else
        set(this.TextLabel,'Rotation',t*180/pi);
      end
    end
