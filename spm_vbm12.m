...
h71  = uimenu(h7,...
	...
	'Separator',	'off',...
	'Tag',		'Display surface',...
	'CallBack','spm_mesh_render(spm_select([1 12],''gifti'',''Select surface''));',...
	'HandleVisibility','on');
h72  = uimenu(h7,...
...
h73  = uimenu(h7,...
	...
	'HandleVisibility','on');
h74  = uimenu(h7,...
	'Label',	'Factorial design specification & estimate',...
	'Separator',	'off',...
	'Tag',		'Factorial design specification &estimate',...
...
h75  = uimenu(h7,...
	...
	'HandleVisibility','on');
h76  = uimenu(h7,...
	'Label',	'Check sample homogeneity using covariance for surfaces',...
	'Separator',	'off',...
	'Tag',		'Check sample homogeneity using covariance for surfaces',...
