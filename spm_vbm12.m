...
spm_help('!Disp','vbm12.man','',Fgraph,'Voxel-based morphometry toolbox for SPM8');
...
h1  = uimenu(h0,...
	...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.estwrite'');',...
	'HandleVisibility','on');
h2  = uimenu(h0,...
	'Label',	'Write already estimated segmentations',...
	'Separator',	'off',...
	'Tag',		'Write segmentations',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.write'');',...
	'HandleVisibility','on');
h3  = uimenu(h0,...
	'Label',	'Process longitudinal data',...
	'Separator',	'off',...
	'Tag',		'Process longitudinal data',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.long'');',...
	'HandleVisibility','on');
h4  = uimenu(h0,...
...
h41  = uimenu(h4,...
	...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.showslice'');',...
	'HandleVisibility','on');
h42  = uimenu(h4,...
	'Label',	'Check sample homogeneity using covariance',...
	'Separator',	'off',...
	'Tag',		'Check sample homogeneity using covariance',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.check_cov'');',...
	'HandleVisibility','on');
h5  = uimenu(h0,...
...
h51  = uimenu(h5,...
	...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.calcvol'');',...
	'HandleVisibility','on');
h52  = uimenu(h5,...
	'Label',	'Threshold and transform spmT-maps',...
	'Separator',	'off',...
	'Tag',		'Threshold and transform spmT-maps',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.T2x'');',...
	'HandleVisibility','on');
h53  = uimenu(h5,...
	'Label',	'Threshold and transform spmF-maps',...
	'Separator',	'off',...
	'Tag',		'Threshold and transform spmF-maps',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.F2x'');',...
	'HandleVisibility','on');
h54  = uimenu(h5,...
	'Label',	'Slice overlay',...
	'Separator',	'off',...
...
h54  = uimenu(h6,...
	...
	'Separator',	'off',...
	'Tag',		'SANLM filter',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.sanlm'');',...
	'HandleVisibility','on');
h55  = uimenu(h6,...
	'Label',	'Intra-subject bias correction',...
	'Separator',	'off',...
	'Tag',		'Intra-subject bias correction',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.bias'');',...
	'HandleVisibility','on');
h56  = uimenu(h6,...
	'Label',	'Apply deformations (Many images)',...
	'Separator',	'off',...
	'Tag',		'Apply deformations (Many images)',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.defs'');',...
	'HandleVisibility','on');
h57  = uimenu(h6,...
	'Label',	'Apply deformations (Many subjects)',...
	'Separator',	'off',...
	'Tag',		'Apply deformations (Many subjects)',...
	'CallBack','spm_jobman(''interactive'','''',''spm.tools.vbm12.tools.defs2'');',...
	'HandleVisibility','on');
h58  = uimenu(h6,...
...
h9  = uimenu(h0,...
	...
	'CallBack','cg_vbm12_update(1);',...
	'HandleVisibility','on');
h10  = uimenu(h0,...
	'Label',	'VBM12 Manual (PDF)',...
	'Separator',	'off',...
	'Tag',		'Open VBM12 Manual',...
	'CallBack','try,open(fullfile(spm(''dir''),''toolbox'',''vbm12'',''VBM12-Manual.pdf''));end',...
	'HandleVisibility','on');
