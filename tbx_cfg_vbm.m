...
cleanupstr.help = {[...
  'Strengh of tissue cleanup after AMAP segmentation. The cleanup removes ' ...
  'meninges and corrects for partial volume effects in special regions. ' ...
  ...
  '',[ ...
  'If parts of brain tissue were missing than decrease the strength.  ' ...
  'If to many meninges are vissible than increase the strength. ' ...
  ],'', ...
};
...
sanlm.help = {[...
  'This function applies an spatial adaptive non local means (SANLM) denoising filter ',...
  'to the data. This filter will remove noise while preserving edges. ', ...
  'The smoothing filter size is automatically estimated based on ',...
  'the local variance in the image. '] ...
 ['Due to variing contrast a second NLM filter is used after inhomogeneity ', ...
  'correction and intensity scaling to remove upcoming noise. ', ...
...
NCstr.help = {[...
  'Strengh of the ORNLM and MRF noise correction. ' ...
  'The default 0.5 was successfully tested on a variety of scans. ' ...
  'Use smaller values (>0) for small changes and higher values (<=1) for stronger corrections. ' ...
  'The value 0 will turn of any noise correction!' ...
  ]};
NCstr.strtype = 'r';
NCstr.num = [1 1];
...
LASstr.help = {[...
  'Strengh of the modification by the Local Adaptive Segmenation (LAS). ' ...
  'The default 0.5 was successfully tested on a variety of scans. ' ...
  'Use smaller values (>0) for small changes and higher values (<=1) for stronger corrections. ' ...
  'The value 0 will deactive LAS.' ...
  ],''};
LASstr.strtype = 'r';
LASstr.num = [1 1];
...
WMHC.help = {[...
  'In aging or diseases WM intensity be strongly reduces in T1 or increased in T2/PD images. ' ...
  'These so called WM hyperintensies (WMHs) can lead to preprocessing errors. ' ...
  'Large GM areas next to the ventricle can cause normalization problems. ' ...
  'Therefore, a temporary correction for the normalization is meaningfull, if WMHs were expected. ' ... 
  'As far as these changes are an important marker, VBM allow different ways to handel WMHs. ' ...
  ],'', ...
  ...
  'See also ...' ...
  ''};
WMHC.labels = {'no WMHC','temporary WMHC',...
  'WMHC - correction to WM like SPM','WMHC - correction to a separate class'};
WMHC.values = {0 1 2 3};
...
WMHCstr.help = {[...
  ...
  'The default 0.5 was successfully tested on a variety of scans. ' ...
  'Use smaller values (>0) for small changes and higher values (<=1) for stronger corrections. ' ...
  'The value 0 will deactive WMHC.' ...
  ],''};
WMHCstr.strtype = 'r';
WMHCstr.num = [1 1];
...
ROI.help = {[...
  ...
  ['    1) Eickhoff SB, Stephan KE, Mohlberg H, Grefkes C, Fink GR, Amunts K, Zilles K. ', ...
   'A new SPM toolbox for combining probabilistic cytoarchitectonic maps and functional imaging data.', ...
   'NeuroImage 25(4), 1325-1335, 2005'], ...
  ['    2) Eickhoff SB, Heim S, Zilles K, Amunts K. ', ...
   'Testing anatomically specified hypotheses in functional imaging using cytoarchitectonic maps. ',...
   'NeuroImage 32(2), 570-582, 2006'], ...
  ['    3) Eickhoff SB, Paus T, Caspers S, Grosbras MH, Evans A, Zilles K, Amunts K.',...
  ...
  ['    1) Zilles K, Amunts K. ',...
   ...
   'Nature Reviews Neuroscience 11(2), 2010: 139-145 '], ...
  ['    2) Amunts K, Schleicher A, Zilles K). ', ...
   'Cytoarchitecture of the cerebral cortex ? more than localization. ', ...
   'Neuroimage 37, 2007: 1061-1065.'], ...
  ['    3) Zilles K, Schleicher A, Palomero-Gallagher N, Amunts K. ', ...
   'Quantitative analysis of cyto- and receptor architecture of the human brain. ',...
   'Brain Mapping: The Methods, J. C. Mazziotta and A. Toga (eds.), USA: Elsevier, 2002, p. 573-602.'], ...
  '', ...
  '(2) Hammers:', ...
  ...
  ['    Hammers A, Allom R, Koepp MJ, Free SL, Myers R, Lemieux L, Mitchell TN, ', ...
   'Brooks DJ, Duncan JS. Three-dimensional maximum probability atlas ', ...
...
'BG=0, CSF=1, GM=2, WM=3, WMH=4 (if WMHC=3)']};
