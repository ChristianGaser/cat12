...
gcutstr.help = {[...
  'Strengh of skull-stripping, with 0 for a softer and wider brain mask ' ...
  'and 1 for a harder and closer result. The default is 0.5 and was '... 
  'successfully tested on a wide set of different image. ' ...
  '' ...
  'The strength change multiple internal parameters: ' ...
  ...
  ' 3) Closing paramters that fill the sulci' ...
  ' 4) Smoothing parameters that allow sharper or wider results ' ...
  '' ...
  'If the brain mask of your images are underestimated, and parts of the ' ...
  'brain are missing, than decrease the strength. If the brain mask of ' ...
  'your images are overestimated, and contain parts of the head, than ' ...
...
LAS.help = {[...
'Adaption for local intensity changes with medium/low spatial frequencies.' ...
'']};
...
l1.help         = {[ ...
  ...
  '' ...
  'This is the option to save an atlas map with sides and major structures (l1). ' ...
  'Odd numbers code the left, even numbers the right side. ' ...
  '' ...
  'Furthermore, aal and broadman atlas maps were created based on maps ' ...
  'from MRIcron that where adapted on the other VBM maps. ' ...
  'Other maps from the IBASPM toolbox. ' ...
