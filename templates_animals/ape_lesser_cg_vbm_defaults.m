function ape_lesser_cg_vbm_defaults
...
% Estimation options
%=======================================================================
vbm.opts.tpm       = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_TPM.nii')};
...
vbm.extopts.darteltpm    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_Template_1.nii')}; % Indicate first Dartel template
vbm.extopts.cat12atlas   = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_cat12.nii')};      % VBM atlas with major regions for VBM, SBM & ROIs
vbm.extopts.brainmask    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_brainmask.nii')};  % brainmask for affine registration
vbm.extopts.T1           = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_T1.nii')};         % T1 for affine registration
