...
% FORMAT cat_defaults_ape_lesser
...
%=======================================================================
cat12.opts.tpm       = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_TPM.nii')};
...
cat12.extopts.species      = 'ape_lesser';  
...
cat12.extopts.darteltpm    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_Template_1.nii')}; % Indicate first Dartel template
cat12.extopts.cat12atlas   = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_vbm12.nii')};      % VBM atlas with major regions for VBM, SBM & ROIs
cat12.extopts.brainmask    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_brainmask.nii')};  % brainmask for affine registration
cat12.extopts.T1           = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','ape_lesser_T1.nii')};         % T1 for affine registration
