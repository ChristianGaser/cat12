...
cat12.extopts.darteltpm    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_Template_1.nii')}; % Indicate first Dartel template
cat12.extopts.cat12atlas   = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_vbm12.nii')};      % VBM atlas with major regions for VBM, SBM & ROIs
cat12.extopts.brainmask    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_brainmask.nii')};  % brainmask for affine registration
cat12.extopts.T1           = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_T1.nii')};         % T1 for affine registration
