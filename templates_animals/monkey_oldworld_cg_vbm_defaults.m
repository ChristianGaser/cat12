...
% Estimation options
%=======================================================================
vbm.opts.tpm       = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_TPM.nii')};
...
vbm.extopts.darteltpm    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_Template_1.nii')}; % Indicate first Dartel template
vbm.extopts.cat12atlas   = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_cat12.nii')};      % VBM atlas with major regions for VBM, SBM & ROIs
vbm.extopts.brainmask    = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_brainmask.nii')};  % brainmask for affine registration
vbm.extopts.T1           = {fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_T1.nii')};         % T1 for affine registration
...
vbm.extopts.atlas       = { ... 
  fullfile(spm('dir'),'toolbox','cat12','templates_animals','monkey_oldworld_dartel_atlas_inia19NeuroMaps.nii') 'gm'    {'csf','gm','wm'} ; ... % good atlas based on 19 subjects
  }; 
