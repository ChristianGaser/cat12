...
% ______________________________________________________________________
  ...
  [Ym,Yp0,resTr]       = vbm_vol_resize({Ym,Yp0}  ,'reduceV',vx_vol,opt.res,64); 
 ...
 %tic
  ...
  for s=1:2
    YMr=vbm_vol_morph(Yl1Ar==opt.LAB.BG(s) & Yl1r==0 & Ymr>1.75 & Ymr<2.75 & Ygr<0.1 & Ydivr>0,'lab'); % basal ganglia
    YMr=vbm_vol_morph(YMr,'lc',2) & Ymr<2.85; Yl1r(YMr)=opt.LAB.BG(1); ER.BG(s)=sum(YMr(:))==0;  
    YMr=vbm_vol_morph(Yl1Ar==opt.LAB.TH(s) & Yl1r==0 & Ymr>1.75 & Ymr<2.75 & Ygr<0.1,'lo',0);         % hypothalamus
  ...
  %Yl1r = vbm_vol_median3c(Yl1r,Ymr>2 & Yl1r>0,Ymr>2 & Yl1r>0);                                    % region smoothing
  %for i=1:8, Yl1r = vbm_vol_median3c(Yl1r,Yl1r>1 & Ymr<2.7,Yl1r>0 & Ymr<2.9); end                 % region smoothing
  ...
  %% original resolution
  Yl1(Yl1>0 & (Ym>2.60 & Ym<2.9) | Ym>3.1)=0; 
  Yl1(Yl1>0 & Ym<2.60 & ~(Yl1==255 | Yl1==opt.LAB.CT(1) | Yl1==opt.LAB.TH(1) | Yl1==opt.LAB.BG(1) | Yl1==opt.LAB.HC(1)))=0; 
  ...
  Yl2 = Yl1; Yl2(Yl2==opt.LAB.ON(1) | smooth3(Yl1==0 & (Yl2==opt.LAB.BG(1) | (Yl1Ans==opt.LAB.BG(1) & Yl1==0) | ...
    Ym<=1.9 | (Yl1Ans~=opt.LAB.CT(1) & Ydiv>-0.1 & Ym<=2.9) | Ym>3.2))>0.5) = -inf; 
...
%tic
  ...
  Yl1(Yl1==0 & (Ym<0.75 & ~vbm_vol_morph(Yl1>0,'lc',2)))=-inf; 
  ...
  Yl1(Yl1==opt.LAB.BV(1) & vbm_vol_morph(Yp0>0,'lc')) = opt.LAB.HD(1); %%%%%%
  clear YM; 
