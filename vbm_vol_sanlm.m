...
% Filter a set of image P and add the prefix 'sanlm_'.
% 
% Structure:
%   vbm_vol_sanlm([P,prefix])
% 
% Examples:
%   vbm_vol_sanlm({'imgage.nii','iamge2.nii'},'n'); 
%   vbm_vol_sanlm           % call GUI to select 
%   vbm_vol_sanlm('','n');  % call GUI to select images with prefix
%
